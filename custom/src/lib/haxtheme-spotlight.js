...
class HaxThemeSpotlight extends DDD {
  static get tag() {
  ...
  constructor() {
    ...
    this.__spotlightConditions = {
      "metadata.type": { value: "spotlight", operator: "=" },
      id: { value: "$activeId", operator: "!=" },
    };
    autorun((reaction) => {
            ...
            <div class="publish_credentials">
              ...
              <div id="author_info">
                ...
                <div id="author">
                  By:
                  <a
                    href="/sites/haxcms-odl/team-directory/${fields.authorId ||
                    ""}"
                    >${metadata.author || ""}</a
                  >
                </div>
...
globalThis.customElements.define(HaxThemeSpotlight.tag, HaxThemeSpotlight);
