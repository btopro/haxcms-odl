import{LitElement as a,html as e,css as t,svg as c}from"../../../lit/index.js";class PolarisMark extends a{static get properties(){return{type:{type:String},name:{type:String},name2:{type:String},name3:{type:String},url:{type:String},vert:{type:Boolean},_haxstate:{type:Boolean},svgwidth:{type:Number},svgheight:{type:Number},linex:{type:Number}}}constructor(){super(),this.type="default",this.name=null,this.name2=null,this.name3=null,this.url="https://psu.edu/",this.vert=!1,this._haxstate=!1,this.svgwidth=600,this.svgheight=180,this.linex=320}static get styles(){return[t`
        :host {
          display: block;
        }
        a:focus-visible {
