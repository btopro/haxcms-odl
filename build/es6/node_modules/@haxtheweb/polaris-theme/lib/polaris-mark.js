import{LitElement as a,html as e,css as t,svg as c}from"../../../lit/index.js";class PolarisMark extends a{static get properties(){return{type:{type:String},name:{type:String},name2:{type:String},name3:{type:String},url:{type:String},vert:{type:Boolean},_haxstate:{type:Boolean},svgwidth:{type:Number},svgheight:{type:Number},linex:{type:Number},name3x:{type:Number}}}constructor(){super(),this._haxstate=!1,this.type="default",this.name=null,this.name2=null,this.name3=null,this.url="https://psu.edu/",this.vert=!1,this.svgwidth=600,this.svgheight=180,this.linex=320,this.name3x=340}static get styles(){return[t`
        :host {
          display: block;
        }
        a:focus-visible {
    ...
    `}renderDefault(a="default"){return c`
      <div id="svg">
        <svg viewBox="0 0 ${this.svgwidth} ${this.svgheight}" xmlns="http://www.w3.org/2000/svg">
          ...
          <line x1="${this.linex}" y1="0" x2="${this.linex}" y2="110" stroke="#96bee6" id="stroke-line" stroke-width="2"></line>
          <text fill="${"default"==this.type?"#1e407c":"#ffffff"}" x="${this.name3x}" y="40" id="name-line3">
            ${this.name3}
          </text> `:""}
        </svg>
      </div>
